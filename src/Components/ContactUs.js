...
const ContactUs = () => {
  return (
    <div>
        <Navbar/>
    <div class="min-h-screen mx-auto py-7" style={{ backgroundColor: '#cdac79' }}>
    <div class="text-center px-6">
        <h2 class="text-center text-5xl font-bold text-brown-light mb-12">Contact Us</h2>
        <p class="text-lg text-black mt-[-30px]">Have some big idea or brand to develop and need help?</p>
    </div>

    <div class="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-5" style={{backgroundColor: '#ffe5b6'}}>


        <div class="bg-[#cdac79] rounded-lg p-6 h-full max-lg:order-1">
            <h2 class="text-xl text-black">Contact Information</h2>
            <p class="text-sm text-black mt-4">Have some big idea or brand to develop and need help?</p>
            ...
            <ul class="mt-16 space-y-8">
                <li class="flex items-center">
                    ...
                    <a href="javascript:void(0)" class="text-black text-sm text-black ml-4">
                        info@example.com
                    </a>
                </li>
                <li class="flex items-center">
        ...
        <div class="p-4 lg:col-span-2">
            <form>
                ...
                <div className="relative flex items-center" style={{ backgroundColor: '#cdac79' }}>
      <input
        type="text"
        placeholder="First Name"
        className="px-2 py-3 bg-white w-full text-sm text-black border-b border-gray-300 focus:border-blue-500 outline-none"
        style={{
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
        ...
        <path
          ...
          data-original="#000000"></path>
                    ...
                    <div className="relative flex items-center sm:col-span-2" style={{ position: 'relative' }}>
      <textarea
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="flex max-lg:flex-col gap-6 mt-4">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-black ml-4">General Inquiry</p>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-black ml-4">Technical Support</p>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-black ml-4">Website Feedback</p>
                            </div>
                        </div>
                    </div>
                </div>
